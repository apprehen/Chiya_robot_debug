...
async def _():
    ...
    sql_str = [
        ...
        (
            "ALTER TABLE hdu_auto_sign_user ADD hours Integer;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu 自动签到时间
        (
            "ALTER TABLE hdu_auto_sign_user ADD minutes Integer;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu 自动签到时间
        (
            "ALTER TABLE hdu_auto_sign_user ADD sessionid Text;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu sessionid
        (
            "ALTER TABLE hdu_auto_sign_user ADD session_update_time timestamp with time zone;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu sports_password
        (
            "ALTER TABLE hdu_auto_sign_user ADD sports_password Text;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu total_run_times
        (
            "ALTER TABLE hdu_auto_sign_user ADD total_run_times Integer;",
            "hdu_auto_sign_user",
        ),  # 新增 hdu course_auto_push
        (
            "ALTER TABLE hdu_auto_sign_user ADD course_auto_push Boolean DEFAULT True;",
            "hdu_auto_sign_user",
        ),
    ]
