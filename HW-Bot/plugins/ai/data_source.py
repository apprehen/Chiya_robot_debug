...
from utils.message_builder import image, face, record
...
def hello() -> str:
    ...
    result = random.choice(
        (
            ...
            "我在呢！",
            "我是HelloWorld的看板娘Chiya!"
        )
    )
    if result == "我是HelloWorld的看板娘Chiya!":
        chiya_voice += record(result, "chiya")
        return result, chiya_voice
